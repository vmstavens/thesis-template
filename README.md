...
<!-- flex parent -->
<div style="display: flex; flex-direction:row; width=100%; margin-left: auto; margin-right: auto; ">
...
<img src="docs/plot.png" style="background-color:white; margin:0px; padding:0px; width: 48%"/>
